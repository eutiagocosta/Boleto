...
public class NovoBoletoComando {
	...
	public NovoBoletoComando(String iBoletoId, BigDecimal quantidadeMoeda,
			BigDecimal valorMoeda, BigDecimal valorDescontos, BigDecimal valorDeducoes,
			BigDecimal valorMulta, BigDecimal valorAcrescimos, String especieMoeda,
			int codigoEspecieMoeda, String especieDocumento, Calendar emissao,
			Calendar processamento, Calendar vencimento,
			String logradouroBeneficiario, String bairroBeneficiario,
			String cepBeneficiario, String cpfBeneficiario, String cidadeBeneficiario,
			String ufBeneficiario, String nomeBeneficiario,
			String agenciaBeneficiario, String digitoBeneficiario,
			String codigoBeneficiario, String digitoCodigoBeneficiario,
			String convenioBeneficiario, String carteiraBeneficiario, String digitoNossoNumero,
			String nossoNumero, String logradouroPagador, String bairroPagador,
			String cepPagador, String cidadePagador, String ufPagador,
			String nomePagador, String cpfPagador, BigDecimal valor,
			String numeroDocumento, String instrucao1, String instrucao2,
